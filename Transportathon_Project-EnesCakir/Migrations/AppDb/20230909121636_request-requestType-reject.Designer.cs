...
namespace Transportathon_Project_EnesCakir.Migrations.AppDb
{
    ...
    [Migration("20230909121636_request-requestType-reject")]
    partial class requestrequestTypereject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyVehicle", b =>
                {
                    b.HasOne("Transportathon_Project_EnesCakir.Entity.Company", null)
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Transportathon_Project_EnesCakir.Entity.Vehicle", null)
                        .WithMany()
